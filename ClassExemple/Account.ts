//export para ser exportavel
//uma classe abstract é uma classe que não pode ser instanciada , apenas pode ser herdada por outras classes
export abstract class AccountDIO{
